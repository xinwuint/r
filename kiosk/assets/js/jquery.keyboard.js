...
;(function (factory) {
	...
	base.insertText = function (txt) {
		...
		var bksp, t,
			...
			if ((len == 0 || flag == 1) && (base.shiftActive)) {
				$keyboard.keyaction.shift(base);
				flag=0;
			}
	...
	$('<!--[if lte IE 8]><script>jQuery("body").addClass("oldie");</script><![endif]--><!--[if IE]>' +
		...
		.appendTo('.keyboard-append')
		.remove();
	$keyboard.msie = $('.keyboard-append').hasClass('oldie'); // Old IE flag, used for caret positioning
	$keyboard.allie = $('.keyboard-append').hasClass('ie');
	...
	$keyboard.checkCaretSupport = function () {
		if (typeof $keyboard.checkCaret !== 'boolean') {
			...
			var $temp = $('<div style="height:0px;width:0px;overflow:hidden;position:fixed;top:0;left:-100px;">' +
				'<input type="text" value="testing"/></div>').prependTo('.keyboard-append'); // stop page scrolling
